  ...
  return (
    <Box sx={{ color: '#fff', padding: '30px', width: '100%' }}>
      ...
      >
        <GameIframe
          token={token?.value}
          url="https://sdk-test.hfrong.cn/game/eliminateStars/index.html"
        />
        ...
        >
          ...
          >
            <AccordionSummary
              expandIcon={
                <ExpandMoreIcon sx={{ color: '#fff', marginTop: '24px', marginBottom: '24px' }} />
              }
            ...
            >
              <Typography sx={{ padding: '0px' }} component="span">
                {data?.name}
              </Typography>
            </AccordionSummary>
